        ...
        <form method="POST" action="done.php">
            ...
            <div class="row">
                <div class="mb-3 form-check col-4">
                    <input name="langs[]" type="checkbox" class="form-check-input" id="php" value="PHP" >
                    <label class="form-check-label" for="php">PHP</label>
                </div>
                <div class="mb-3 form-check col-4">
                    <input name="langs[]" type="checkbox" class="form-check-input" id="js" value="JavaScript" >
                    <label class="form-check-label" for="js">JS</label>
                </div>
                <div class="mb-3 form-check col-4">
                    <input name="langs[]" type="checkbox" class="form-check-input" id="python" value="Python" >
            ...
            <div class="mb-3">
                ...
                <input name="pass" type="text" class="form-control" id="pass" value="">
            </div>
            <div class="mb-3">
